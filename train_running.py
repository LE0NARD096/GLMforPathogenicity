...
# Load the standard configuration
    config = BertConfig.from_pretrained("zhihan1996/DNABERT-2-117M", trust_remote_code=True, output_attentions=True, return_dict=True)

# Load the model with the standard configuration
